...
import {verifyAccessToken, verifyRefreshToken, signAccessToken} from "../libs/token.js";
...
export const AuthGuard = async (req, res, next) => {
  ...
  if (accessToken) {
    ...
    const user = await userModel.findById(decoded?.sub).select("+refreshToken -password");
    req.user = user;
    return next();
  }
